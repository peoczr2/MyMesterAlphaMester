/*
Megoldás lényege:
Az épületek uniójának komplementerében keressük a korlátos lyukakat. Koordináta-kompresszióval és komponensszámlálással kapjuk meg a belső udvarokat.
*/
#include <bits/stdc++.h>
using namespace std;
    ...
    for (int j = 0; j < H; ++j) {
        ...
        for (int i = 0; i < W; ++i) {
            ...
            if (emptyCell) {
                ...
                int node = dsu.addNode(width * yh, 2LL * (width + yh), ex, ys[j], (long long)xs[l]);
