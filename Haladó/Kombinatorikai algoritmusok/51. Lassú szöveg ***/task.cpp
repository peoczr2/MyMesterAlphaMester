/*
   Lassú szöveg: a szomszédos karakterek az ábécében szomszédosak.
   A sorrend a prefixfán végzett bejárás, ezért rangsorolással és unrankinggel
   megoldható az előző és a következő szó is.
*/
#include <bits/stdc++.h>
using namespace std;
